...
class CardOnTable {
 public:
  ...
  explicit CardOnTable(Card attack_card) noexcept;
  ...
  /*======================== Modifiers =========================*/
  void beat(Card beat_card) noexcept;

  /*========================= Getters ==========================*/
  [[nodiscard]] Card get_attack_card() const noexcept;

  [[nodiscard]] Card get_beat_card() const;

  [[nodiscard]] bool is_beaten() const noexcept;
...
class Table {
 public:
  ...
  /*========================= Getters ==========================*/
  [[nodiscard]] const cards_on_table_t& get_cards() const noexcept;
